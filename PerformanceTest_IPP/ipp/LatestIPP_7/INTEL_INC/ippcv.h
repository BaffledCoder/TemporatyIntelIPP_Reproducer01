...
//    Notes:                   The output is the double pointer to support the circle buffer
//F*/
...
//    divisor                  The value to divide output pixels by , (for integer functions)
//    pBuffer                  The pointer to the working buffer
//    Notes:                   The input is the double pointer to support the circle buffer
//F*/
...
//
//  Purpose: Calculate both eigenvalues and eigenvectors of 2x2 autocorrelation
...
//
//  Purpose: Calculate minimal eigenvalue of 2x2 autocorrelation gradient matrix
//           for every pixel. Pixels with relatively large minimal eigenvalues
...
//    pSrc                     Source image
//    srcStep                  Its step in bytes
//    pMinEigenVal             Image, filled with minimal eigenvalues for every pixel
...
//                                30 - 3x3 aperture for infinity norm,
//                                31 - 3x3 aperture for L1 norm,
//                                32 - 3x3 aperture for L2 norm,
//                                50 - 5x5 aperture for infinity norm,
...
//             when the corresponding pixels in the silhouette image are non zero.
...
//
//  Purpose:    Initializes structure for creating a lower(an upper) pyramid layer.
//
//  Arguments:
...
//    orientationBins   The number bins for defining direction
//    option            defines the modes of processing
...
//    ippStsOutOfRangeErr       Indicates an error when orientation Bins or N have an illegal value.
//    ippStsBadArgErr           Indicates an error when option or circleRadius have an illegal value.
//    ippStsThresholdErr        threshold is less 0
*/
...
//    pSrc              Pointer to the source image
//    srcStep           Step through the source image
//    pDstCorner        Pointer to the destination corner image
//    dstCornerStep     Step through the destination corner image
//    pDstScore         Pointer to the destination score image
//    dstScoreStep      Step through the destination score image

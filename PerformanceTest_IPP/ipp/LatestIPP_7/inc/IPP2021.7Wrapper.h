...
namespace latestIPP_7
{
	...
	IPP_API int Mean_StdDev_8u_C1R_IPP2021_7(Ipp8u *pDst, SINT32_T srcStep, DOUBLE_T* pMean, DOUBLE_T* pStdDev, SINT32_T Width, SINT32_T Height, Profiler *profiler);
}

...
//    ippChan     - Intel(R) IPP channels name of the source images. Possible values are ippC1, ippC3 or ippAC4.
...
//    ippStsNoErr             - OK.
//    ippStsNullPtrErr        - Error when any of the specified pointers is NULL.
//    ippStsBadArgErr         - Error when pSpec object not initialized.
*/
...
//    ippStsBadArgErr  - Error when pSpec initialized incorrect.
*/
...
//    numChannels    - Intel(R) IPP channels name of the images. Possible values are ippC1, ippC3, ippC4 or ippAC4.
...
//    numChannels    - Intel(R) IPP channels name of the images. Possible values are ippC1, ippC3, ippC4 or ippAC4.
//    roiSize        - Size, in pixels, of the destination ROI.
//    pValues        - Pointer to the array of intensity values, separate for each channel.
...
//   dataType           Data type of the source an destination images.
...
//   ippStsSizeErr      Indicates an error condition if dstRoiSize has a field with zero or negative value.
...
//
//  Purpose: Calculate Otsu threshold value of images
//    Return:
//      ippStsNoErr              Ok
//      ippStsNullPtrErr         One of pointers is NULL
...
//      pThreshold               Returned Otsu threshold value
//
//F*/
...
//    ippStsMaskSizeErr         fields of maskSize are not equal or ones are less or equal 0
//    ippStsDataTypeErr         Indicates an error when dataType has an illegal value.
//    ippStsNumChannelsErr      Indicates an error when numChannels has an illegal value.
*/
...
IPPAPI(IppStatus, ippiTranspose_32fc_C1R, ( const Ipp32fc* pSrc, int srcStep, Ipp32fc* pDst, int dstStep, IppiSize roiSize ))
...
//    xShift, yShift    Specify shifts of resizing
...
IPPAPI(IppStatus, ippiResizeSuperShiftInit_8u, (
    IppiSize srcSize, IppiSize dstSize,
    Ipp64f xShift, Ipp64f yShift,
    IppiBorderType borderType, const Ipp8u * borderVal,
    int smoothEdge, int numChannels,
    IppiResizeSpec_32f* pSpec))
IPPAPI(IppStatus, ippiResizeSuperShiftInit_16u, (
    IppiSize srcSize, IppiSize dstSize,
    Ipp64f xShift, Ipp64f yShift,
    IppiBorderType borderType, const Ipp16u * borderVal,
    int smoothEdge, int numChannels,
    IppiResizeSpec_32f* pSpec))
IPPAPI(IppStatus, ippiResizeSuperShiftInit_16s, (
    IppiSize srcSize, IppiSize dstSize,
    Ipp64f xShift, Ipp64f yShift,
    IppiBorderType borderType, const Ipp16s * borderVal,
    int smoothEdge, int numChannels,
    IppiResizeSpec_32f* pSpec))
IPPAPI(IppStatus, ippiResizeSuperShiftInit_32f, (
    IppiSize srcSize, IppiSize dstSize,
    Ipp64f xShift, Ipp64f yShift,
    IppiBorderType borderType, const Ipp32f * borderVal,
    int smoothEdge, int numChannels,
    IppiResizeSpec_32f* pSpec))
...
IPPAPI (IppStatus, ippiResizeAntialiasingLinearInit_64f, (
    IppiSize srcSize, IppiSize dstSize, IppiResizeSpec_64f* pSpec,
    Ipp8u* pInitBuf))
...
IPPAPI (IppStatus, ippiResizeAntialiasingCubicInit_64f, (
    IppiSize srcSize, IppiSize dstSize, Ipp64f valueB,
    Ipp64f valueC, IppiResizeSpec_64f* pSpec, Ipp8u* pInitBuf))

IPPAPI (IppStatus, ippiResizeAntialiasingLanczosInit, (
    IppiSize srcSize, IppiSize dstSize, Ipp32u numLobes,
    IppiResizeSpec_32f* pSpec, Ipp8u* pInitBuf))
    
IPPAPI (IppStatus, ippiResizeAntialiasingLanczosInit_64f, (
    IppiSize srcSize, IppiSize dstSize, Ipp32u numLobes,
...
IPPAPI (IppStatus, ippiResizeAntialiasing_64f_C1R, (
    const Ipp64f* pSrc, Ipp32s srcStep, Ipp64f* pDst,
    Ipp32s dstStep, IppiPoint dstOffset, IppiSize dstSize,
    IppiBorderType border, const Ipp64f* pBorderValue,
    const IppiResizeSpec_64f* pSpec, Ipp8u* pBuffer))
...
//    srcStep     step through the source image
//    srcRoiSize  size of source ROI (pixels)
...
//    mask        operator size specifier
//    normType    normalization type (L1 or L2) specifier
//    borderType  kind of border specifier
...
//    ippStsSizeErr        ROI has any field with zero or negative value
//    ippStsMaskSizeErr    illegal maskSize specifier value
//    ippStsBadArgErr      illegal normType specifier value
//    ippStsBorderErr      illegal borderType specifier value
*F*/
...
//                         - block has not 2x2 cell geometry
...
//    ippStsSizeErr        Indicates an error if roiSize doesn't match to HOG context
...
//  Parameters:
//    pSrc              pointer to source volume data (8u_C1V, 16u_C1V, 16s_C1V, 32f_C1V modes)
...
//    srcPlaneStep      step between planes of source volume (8u_C1V, 16u_C1V, 16s_C1V, 32f_C1V modes)
//    srcVOI            volume of interest of source volume
//    pDst              pointer to destination volume data (8u_C1V, 16u_C1V, 16s_C1V modes)
//                      or array of pointers to planes in destination volume data
//    dstStep           step in every plane of destination volume
//    dstPlaneStep      step between planes of destination volume (8u_C1V, 16u_C1V, 16s_C1V, 32f_C1V modes)
...
//                            (interpolation != IPPI_INTER_CUBIC2P_B05C03)
//  Notes:
//    <mode> are 8u_C1V or 16u_C1V or 16s_C1V or 32f_C1V or 8u_C1PV or 16u_C1PV or 16s_C1PV or 32f_C1PV
*/
...
IPPAPI(IppStatus, ipprResize_16s_C1V, (
    const Ipp16s* pSrc, IpprVolume srcVolume, int srcStep, int srcPlaneStep, IpprCuboid srcVOI,
    Ipp16s* pDst, int dstStep, int dstPlaneStep, IpprCuboid dstVOI,
    double xFactor, double yFactor, double zFactor, double xShift, double yShift, double zShift,
    int interpolation, Ipp8u* pBuffer))
...
IPPAPI(IppStatus, ipprResize_16s_C1PV, (
    const Ipp16s* const pSrc[], IpprVolume srcVolume, int srcStep, IpprCuboid srcVOI,
    Ipp16s* const pDst[], int dstStep, IpprCuboid dstVOI,
    double xFactor, double yFactor, double zFactor, double xShift, double yShift, double zShift,
    int interpolation, Ipp8u* pBuffer))
...
/*
//  Purpose:    Image smoothing via Iterative Least Squares.
//  Parameters:
//   pSrc          Pointer to the source image
//   srcStep       Step through the source image
//   pDst          Pointer to the destination image
//   dstStep       Step in destination image
//   filter        Filter type(Norm, Welsch)
//   dataType      Data type flavors
//   dstRoiSize    Size of the ROI
//   numChannels   Number of channels
//   pSpecSize     Pointer to the size (in bytes) of the spec
//   pBufInitSize  Pointer to the size (in bytes) of init temp buffer
//   pBufferSize   Pointer to the size (in bytes) of work buffer
//   lambda        Lambda for Norm and Welsch
//   eps           Eps    for Norm
//   p             P      for Norm
//   gamma         Gamma  for Welsch
//   pBufInit      Pointer to the buffer for init function
//   pSpec         Pointer to the spec.
//   pBuffer       Pointer to the work buffer.
...
IPPAPI(IppStatus, ippiFilterILSGetBufferSize, (IppiFilterILSType filter, IppiSize dstRoiSize, IppDataType dataType, int numChannels, int *pSpecSize, int* pBufInitSize, int *pBufferSize))
IPPAPI(IppStatus, ippiFilterILSInit,          (IppiFilterILSType filter, IppiSize dstRoiSize, IppDataType dataType, int numChannels, Ipp64f lambda, Ipp64f eps, Ipp64f pow, Ipp64f gamma, IppiFilterILSSpec *pSpec, Ipp8u* pBufInit))
IPPAPI(IppStatus, ippiFilterILS_8u_C1R,       (const Ipp8u *pSrc, int srcStep, Ipp8u *pDst, int dstStep, IppiSize dstRoiSize, int nIter, IppiFilterILSSpec *pSpec, Ipp8u* pBuffer))
IPPAPI(IppStatus, ippiFilterILS_8u_C3R,       (const Ipp8u *pSrc, int srcStep, Ipp8u *pDst, int dstStep, IppiSize dstRoiSize, int nIter, IppiFilterILSSpec *pSpec, Ipp8u* pBuffer))
